...
import { ReactComponent as GitIcon } from '../../../MyAsset/git.svg';
    ...
    <div className="portfolio-container">
      <div className="overlay">
        <div className="top">
          ...
          <span className="home-button1" onClick={scrollToBottom}>
            About
          </span>
          <span className="home-button2" onClick={scrollToBottom1}>
            Service
          </span>
          <span className="home-button3" onClick={scrollToBottom2}>
            Portfolio
          </span>
          <span className="home-button3" onClick={scrollToBottom3}>
            Contact
          </span>
        </div>
        <div className="middle">
          ...
          <div className="portfolio-container2">
            ...
            <div className="port">
              ...
              <p>
                Deborah's thirst for knowledge and her unwavering commitment to
              </p>
              <p>
                excellence have enabled her to become a leading professional in
                her field.
              </p>
              <p>
                She graduated from Semicolon Africa 🎓, a renowned technology
                institution
              </p>
              <p>
                that has a reputation for producing top-notch professionals in
                the field of
              </p>
              <p>software engineering.</p>
              <p>
                Her strong academic background and experience in the industry
              ...
              <p>
                Deborah has a wealth of knowledge and skills that enable her to
                develop innovative solutions
              </p>
              <p>to complex software problems 💡.</p>
              <p>
                As a software engineer, Deborah is dedicated to making a
                positive impact in the world through
              </p>
              <p>
                her work 🌍. She is committed to using technology to drive
                positive change and is always exploring new ways to apply her
                skills and knowledge to create solutions that make a difference
                🌟.
              </p>
            </div>
          </div>
          <div className="portfolio-container3">
            ...
            <div className="theBox">
              ...
              <div className="box2">
                ...
                <p>
                  We develop efficient, effective, lightweight application
                  <br />
              ...
              <div className="box3">
                ...
                <p>
                  We put user at the center <br />
                  of every stage of our SDLC and
                  <br />
